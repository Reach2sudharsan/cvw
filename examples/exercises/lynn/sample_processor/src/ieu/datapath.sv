...
//     always_comb begin
//         case (ALUFunctM[1:0])
//             2'b00:   productM = origProductM[31:0];  // MUL: lower 32 bits
//             default: productM = origProductM[63:32]; // MULH/MULHU/MULHSU: upper 32 bits
//         endcase
//     end
...
module datapath #(
    ...
    // assign pht_indexE = GHRE ^ buffer_indexE;
    ...
    // always_comb begin
    //     logic signed [63:0] t0, t1, t2, t3;

    //     // Level 1: 16 → 8
    //     t0 = {{46{P00M[17]}}, P00M}             + ({{46{P01M[17]}}, P01M} <<  8);
    //     t1 = ({{46{P02M[17]}}, P02M} << 16)     + ({{46{P03M[17]}}, P03M} << 24);
    //     t2 = ({{46{P10M[17]}}, P10M} <<  8)     + ({{46{P11M[17]}}, P11M} << 16);
    //     t3 = ({{46{P12M[17]}}, P12M} << 24)     + ({{46{P13M[17]}}, P13M} << 32);

    //     // Level 2: 8 → 4  (reuse t0–t3)
    //     t0 = t0 + t1;
    //     t1 = t2 + t3;
    //     t2 = ({{46{P20M[17]}}, P20M} << 16)     + ({{46{P21M[17]}}, P21M} << 24);
    //     t3 = ({{46{P22M[17]}}, P22M} << 32)     + ({{46{P23M[17]}}, P23M} << 40);

    //     // Level 3: 4 → 2  (reuse t0–t3)
    //     t0 = t0 + t1;
    //     t1 = t2 + t3;
    //     t2 = ({{46{P30M[17]}}, P30M} << 24)     + ({{46{P31M[17]}}, P31M} << 32);
    //     t3 = ({{46{P32M[17]}}, P32M} << 40)     + ({{46{P33M[17]}}, P33M} << 48);

    //     // Level 4: 2 → 1
    //     t2 = t2 + t3;
    //     origProductM = (t0 + t1) + t2;
    // end
    // always_comb begin
    //     logic [31:0] lo0, lo1, lo2, lo3;
    //     logic [31:0] hi0, hi1, hi2, hi3;
    //     logic [63:0] tmp;

    //     // Helper: each term is PPij << shift, split into lo/hi 32-bit halves
    //     // lo = bits [31:0], hi = bits [63:32] of the sign-extended shifted product

    //     // Level 1: 16 → 8, compute {hi,lo} pairs
    //     tmp = {{46{P00M[17]}}, P00M}         + ({{46{P01M[17]}}, P01M} <<  8);
    //     lo0 = tmp[31:0]; hi0 = tmp[63:32];

    //     tmp = ({{46{P02M[17]}}, P02M} << 16) + ({{46{P03M[17]}}, P03M} << 24);
    //     lo1 = tmp[31:0]; hi1 = tmp[63:32];

    //     tmp = ({{46{P10M[17]}}, P10M} <<  8) + ({{46{P11M[17]}}, P11M} << 16);
    //     lo2 = tmp[31:0]; hi2 = tmp[63:32];

    //     tmp = ({{46{P12M[17]}}, P12M} << 24) + ({{46{P13M[17]}}, P13M} << 32);
    //     lo3 = tmp[31:0]; hi3 = tmp[63:32];
    ...
    //     tmp = ({{46{P20M[17]}}, P20M} << 16) + ({{46{P21M[17]}}, P21M} << 24);
    //     lo2 = tmp[31:0]; hi2 = tmp[63:32];

    //     tmp = ({{46{P22M[17]}}, P22M} << 32) + ({{46{P23M[17]}}, P23M} << 40);
    //     lo3 = tmp[31:0]; hi3 = tmp[63:32];
    ...
    //     tmp = ({{46{P30M[17]}}, P30M} << 24) + ({{46{P31M[17]}}, P31M} << 32);
    //     lo2 = tmp[31:0]; hi2 = tmp[63:32];

    //     tmp = ({{46{P32M[17]}}, P32M} << 40) + ({{46{P33M[17]}}, P33M} << 48);
    //     lo3 = tmp[31:0]; hi3 = tmp[63:32];
    ...
    //     origProductM = {hi0, lo0} + {hi1, lo1} + {hi2, lo2};
    // end
